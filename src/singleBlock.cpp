...
void nuc3d::singleBlock::initialBlock()
{
    ...
    myBlock.initial(myOperator,myPhys,myMPI,myIO);
}
...
void nuc3d::singleBlock::solvePDE()
{
    ...
    {
        myBlock.solve(myOperator, myPhys, myMPI,myIO);
...
void nuc3d::singleBlock::postprocess()
{
    ...
    myBlock.Post(myOperator, myPhys, myMPI, myIO);
    myMPI.barrier();
}
...
void nuc3d::singleBlock::output()
{
    ...
    myBlock.Output(myOperator, myPhys, myMPI,myIO);
    myMPI.barrier();
}
