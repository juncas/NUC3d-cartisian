    ...
    for(int k=kbeg;k<kend;k++)
    {
        ...
        for(int j=jbeg;j<jend;j++)
        {
            ...
            {       
                ...
                double is0=std::pow((pData_in[i-1]-pData_in[i]),2);
                double is1=std::pow((pData_in[i]-pData_in[i+1]),2);
                
                double q20=-0.5*pData_in[i-1]+1.5*pData_in[i];
                double q21=0.5*pData_in[i]+0.5*pData_in[i+1];
    ...
    for(int k=kbeg;k<kend;k++)
    {
        ...
        for(int j=jbeg;j<jend;j++)
        {
            ...
            {       
                ...
                double is0=std::pow((pData_in[i+2]-pData_in[i+1]),2);
                double is1=std::pow((pData_in[i+1]-pData_in[i]),2);
                
                double q20=-0.5*pData_in[i+2]+1.5*pData_in[i+1];
                double q21=0.5*pData_in[i+1]+0.5*pData_in[i];
