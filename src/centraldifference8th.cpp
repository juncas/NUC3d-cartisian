                                                    ...
                                                    const int tilesize)
{
    ...
    for(int k=kbeg;k<kend;k++)
    {
        ...
        {
                int idx_f_j=idx_f_k+nx*j;
            for(int i=ibeg;i<iend;i++)
            {
                int idx_f=idx_f_j+i;

                double an =  (coeff_cd8_alpha[3]*pIn[idx_f-4]
                            +coeff_cd8_alpha[2]*pIn[idx_f-3]
                            +coeff_cd8_alpha[1]*pIn[idx_f-2]
                            +coeff_cd8_alpha[0]*pIn[idx_f-1]);

                double ap = (coeff_cd8_alpha[0]*pIn[idx_f+1]
                            +coeff_cd8_alpha[1]*pIn[idx_f+2]
                            +coeff_cd8_alpha[2]*pIn[idx_f+3]
                            +coeff_cd8_alpha[3]*pIn[idx_f+4]);
