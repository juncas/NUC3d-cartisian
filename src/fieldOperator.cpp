...
void nuc3d::fieldOperator3d::setMethodIvsX()
{
    ...
    {
        bufferSize_xi=4;
        myInteroplators.push_back(std::make_shared<hccs78>());
    }
    else if(s=="hccs")
    {
        bufferSize_xi=4;
                                             ...
                                             Field & fieldOUT)
{
    ...
    {
        case 0:
            myDifferenters[0]->differentialInner(fieldIN,dx,fieldOUT,bufferSize_xi);
            break;
        case 1:
            myDifferenters[1]->differentialInner(fieldIN,dx,fieldOUT,bufferSize_eta);
            break;
        case 2:
            myDifferenters[2]->differentialInner(fieldIN,dx,fieldOUT,bufferSize_zeta);
            break;
    }
}
                                                ...
                                                )
{
        ...
        differenceBoundaryInnerL(fieldIN,dx,boundaryL,direction,fieldOUT);

        differenceBoundaryInnerR(fieldIN,dx,boundaryR,direction,fieldOUT);
}
                                                      ...
                                                      Field &fieldOUT)
{
    ...
    {
        case 0:
            myDifferenters[0]->differentialBoundaryL(fieldIN,dx,boundaryL,fieldOUT,bufferSize_xi);
            break;
        case 1:
            myDifferenters[1]->differentialBoundaryL(fieldIN,dx,boundaryL,fieldOUT,bufferSize_eta);
            break;
        case 2:
            myDifferenters[2]->differentialBoundaryL(fieldIN,dx,boundaryL,fieldOUT,bufferSize_zeta);
            break;
    }
}
                                                         ...
                                                         Field &fieldOUT)
{
    ...
    {
        case 0:
            myDifferentersBND[0]->differentialBoundaryL(fieldIN,dx,boundaryL,fieldOUT,bufferSize_xi);
            break;
        case 1:
            myDifferentersBND[1]->differentialBoundaryL(fieldIN,dx,boundaryL,fieldOUT,bufferSize_eta);
            break;
        case 2:
            myDifferentersBND[2]->differentialBoundaryL(fieldIN,dx,boundaryL,fieldOUT,bufferSize_zeta);
            break;
    }
                                                      ...
                                                      Field &fieldOUT)
{
    ...
    {
        case 0:
            myDifferenters[0]->differentialBoundaryR(fieldIN,dx,boundaryR,fieldOUT,bufferSize_xi);
            break;
        case 1:
            myDifferenters[1]->differentialBoundaryR(fieldIN,dx,boundaryR,fieldOUT,bufferSize_eta);
            break;
        case 2:
            myDifferenters[2]->differentialBoundaryR(fieldIN,dx,boundaryR,fieldOUT,bufferSize_zeta);
            break;
    }
                                                         ...
                                                         Field &fieldOUT)
{
    ...
    {
        case 0:
            myDifferentersBND[0]->differentialBoundaryR(fieldIN,dx,boundaryR,fieldOUT,bufferSize_xi);
            break;
        case 1:
            myDifferentersBND[1]->differentialBoundaryR(fieldIN,dx,boundaryR,fieldOUT,bufferSize_eta);
            break;
        case 2:
            myDifferentersBND[2]->differentialBoundaryR(fieldIN,dx,boundaryR,fieldOUT,bufferSize_zeta);
            break;
    }
